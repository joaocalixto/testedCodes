...
/**
 * The core public access point to the jsoup function ality.
 * 
...
public class Jsoup2 {
	...
	public static String clean(String bodyHtml, String baseUri, Whitelist whitelist) {
		Document dirty = Jsoup2.parseBodyFragment(bodyHtml, baseUri);
	...
	public static String clean(String bodyHtml, Whitelist whitelist) {
		return Jsoup2.clean(bodyHtml, "", whitelist);
	}

	/**
	 * Creates a new {@link Connection2tion} to a URL. Use to fetch and parse a
	 * HTML page.
	 * <p>
	 * Use examples:
	 * <ul>
	...
	public static Connection2 connect(String url) {
		return HttpConnection2.connect(url);
	}
	...
	public static boolean isValid(String bodyHtml, Whitelist whitelist) {
		Document dirty = Jsoup2.parseBodyFragment(bodyHtml, "");
		Cleaner cleaner = new Cleaner(whitelist);
	...
	public static Document parse(URL url, int timeoutMillis) throws IOException {
		Connection2 con = HttpConnection2.connect(url);
